...
export const contactSummarySchema = contactSchema.omit({ notes: true }).extend({ opportunity_count: z.number().int().nonnegative().optional(), last_interaction: z.string().nullable().optional(), company: z.object({ id: z.uuid(), name: z.string() }).nullable().optional() });
